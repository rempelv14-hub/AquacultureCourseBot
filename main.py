...
TEXTS = {
    "ru": {
        ...
        "tariffs": (
            "🔥 <b>ОГРАНИЧЕННАЯ АКЦИЯ</b>\n"
            "⏳ Скидка доступна только сейчас\n\n"

            "Тариф 1: «Премиум сопровождение»\n"
            "❌ 250 000 тг\n"
            "✅ <b>150 000 тг (скидка 40%)</b>\n\n"
            ...
            "Тариф 2: «Базовое обучение»\n"
            "❌ 150 000 тг\n"
            "✅ <b>105 000 тг (скидка 30%)</b>\n\n"
        ...
        "intro_fail": "Ошибка отправки видео",
        "module_not_set": "⚠️ Модуль не настроен",
    },
